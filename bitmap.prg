...
CLASS TBitmap FROM TControl
   ...
   METHOD nHeight() INLINE If( ::lDrag, Super:nHeight(),;
                           If( ::hBitmap != 0,;
                               nBmpHeight( ::hBitmap ) * ::nZoom, 0 ) )

   METHOD nWidth() INLINE  If( ::lDrag, Super:nWidth(),;
                           If( ::hBitmap != 0,;
...
METHOD New( nTop, nLeft, nWidth, nHeight, cResName, cBmpFile, lNoBorder,;
            ...
            cMsg, cTooltip, lUpdate, bWhen, lPixel, bValid, lDesign ) CLASS TBitmap
...
METHOD LoadFromClipboard() CLASS TBitmap
